  ...
  public void setShotPoints() {
    if (DriverStation.isDSAttached()) {
      if (DriverStation.getAlliance().get() == Alliance.Blue) {
        ...
        neutralTopZone.setShotPoint(FieldZoneConstants.BLUE_HUB_SHOT_POINT, false);
        neutralBottomZone.setShotPoint(FieldZoneConstants.BLUE_HUB_SHOT_POINT, false);
        ...
        neutralTopZone.setShotPoint(FieldZoneConstants.RED_HUB_SHOT_POINT, false);
        neutralBottomZone.setShotPoint(FieldZoneConstants.RED_HUB_SHOT_POINT, false);
